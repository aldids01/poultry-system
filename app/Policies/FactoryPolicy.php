...
class FactoryPolicy
{
    ...
    {
        return $user->can('view_any_factory');
    }
    ...
    {
        return $user->can('create_factory');
    }
    ...
    {
        return $user->can('update_factory');
    }
    ...
    {
        return $user->can('delete_factory');
    }
    ...
    {
        return $user->can('delete_any_factory');
    }
    ...
    {
        return $user->can('force_delete_factory');
    }
    ...
    {
        return $user->can('force_delete_any_factory');
    }
    ...
    {
        return $user->can('restore_factory');
    }
    ...
    {
        return $user->can('restore_any_factory');
    }
