    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('blast_freezer_temperature')
                    ->maxLength(255),
                Forms\Components\TextInput::make('cold_room_temperature')
                    ->maxLength(255),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('product.name')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('blast_freezer_temperature')
                    ->searchable(),
                Tables\Columns\TextColumn::make('cold_room_temperature')
                    ->searchable(),
